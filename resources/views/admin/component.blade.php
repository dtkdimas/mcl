                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="card-title">
                            <a href="{{ route('admin.component.create') }}" class="btn btn-primary btn-sm">
                                        ...
                                        @foreach ($component as $item)
                                            <tr class="">
                                                ...
                                                <td class="d-flex gap-2">
                                                    <a href="{{ route('admin.component.edit', $item->id) }}"
        ...
        <div class="modal fade" id="deleteModal-{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ url('admin/component/' . $item->id) }}" method="post">
                        @method('DELETE')
                        @csrf
