...
<body data-theme="light">
    ...
    <div class="sidebar-nav-wrapper">
        <div class="sidebar-nav">
            <a href="{{ url('admin/dashboard') }}" class="login-btn">
                Dashboard
                                    ...
                                    <div class="accordion-item item-child">
                                        <h2 class="accordion-header header-child">
                                            <button class="accordion-button collapsed btn-child" type="button"
                                                ...
                                                aria-expanded="true" aria-controls="panelsStayOpen-{{ $category->id }}">
    ...
    <div class="container-xxl bd-gutter bd-layout">
        <aside class="bd-sidebar">
            <div class="offcanvas-body flex-column">
                ...
                <a href="{{ url('admin/dashboard') }}" id="login-btn" class="login-btn">
                    Dashboard
                    <div class="d-flex align-items-center">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="/" id="introduction" class="introduction">
                    Getting Started
                </a>
                @foreach ($years as $year)
                                            ...
                                            <div id="panelsStayOpen-{{ $category->id }}"
                                                ...
                                                <div class="accordion-body body-child">
                                                    @foreach ($category->components as $component)
                                                        <ul>
                                                            <li>
                                                                <a href="{{ route('admin.view.component', ['year' => $year->year, 'category' => $category->category, 'id' => $component->id, 'component' => $component->component]) }}"
                                                                    class="link">{{ $component->component }}</a>
                                                            </li>
                                                        </ul>
                                                    @endforeach
    ...
    <script>
        ...
        function selectInput(year, category, id, component) {
            window.location.href =
                "{{ route('admin.view.component', ['year' => ':year', 'category' => ':category', 'id' => ':id', 'component' => ':component']) }}"
                .replace(':year', year)
