...
@section('title', 'Super Admin - Category')
@section('content')
    ...
    <div class="modal fade" id="createModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ url('super-admin/category') }}" method="POST">
                    @csrf
    ...
    @foreach ($category as $categoryItem)
        <div class="modal fade" id="editModal-{{ $categoryItem->id }}" data-bs-backdrop="static"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ url('super-admin/category/' . $categoryItem->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="modal-header">
    ...
    @foreach ($category as $item)
        <div class="modal fade" id="deleteModal-{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ url('super-admin/category/' . $item->id) }}" method="post">
                        @method('DELETE')
                        @csrf
                        <div class="modal-header">
